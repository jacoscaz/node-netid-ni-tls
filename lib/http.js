...
var debug = require('debug')('webid:http');
...
function requestRDFData(uri) {
  ...
  debug('Retrieving RDF data for uri %s...', uri);
  return new Promise(function (resolve, reject) {
